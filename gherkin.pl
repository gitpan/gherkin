...
sub help {
    ...
    print STDERR "Usage: gherkin.pl [--features=/some/dir] [--steps=/some/dir/] [--feature_file=/some/file.feature] [--tag=some_tag] [--help]\n"
...
gherkin.pl - A Perl implementation of Aslak Hellesøy's Cucumber BDD framework.
...
Gherkin is my Perl implementation of Cucumber. So it's like Cucumber but smaller and uglier. See the SEE ALSO section for more about Cucumber.
